...
<div id="task-page-content-wrapper">
		...
		<div id="contenedor-default">
			...
			<div class="login_box">
				...
				<div class="alert alert-danger" role="alert" style="margin-top:20px;"><i class="fa fa-exclamation-circle"></i> Debe ingresar <strong>Usuario</strong> y <strong>Password</strong> correctos</div>
